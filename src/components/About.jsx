      ...
      <div className="container mx-auto px-4 ">
        <div className="grid md:grid-cols-2 gap-16 items-center max-w-7xl mx-auto relative z-10">
          ...
          > 
            ...
            <p className="text-2xl md:text-2xl font-sub text-center md:text-left" style={{color: 'red'}}>Criação que impacta. Estratégia que converte.</p>
            <p className="text-lg text-gray-600 leading-relaxed text-justify font-sub">
